...
<div className="bg-gray-700 text-white p-5 h-24 w-full flex justify-between items-center">
  <div className="text-white text-2xl font-bold">Evento</div>
...
<Link to='/user/register' >Register</Link>
         ...
         {/* Mobile Menu Button (Hamburger) */}
          <button className='md:hidden '  onClick={toggleMobileMenu}  ><BiMenu color='white'  size={32}/></button>
 ...
 <li>
            <Link to="/user/register" className="block text-white hover:text-gray-400" onClick={toggleMobileMenu}>
              Register
            </Link>
          </li>
          <li>
